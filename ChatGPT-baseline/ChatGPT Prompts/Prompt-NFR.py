...
- The product shall be able to support 1 000 simultaneous users.
- The product shall be capable of handling the existing 1 000 users; this number is expected to grow five-fold within the next year.
- The system shall be able to handle all user requests/usage during business hours.
...
- The product shall be internet-browser-independent; it must run using Internet Explorer and Netscape Navigator.
- Application updates shall occur between 3 AM and 6 AM CST on Wednesday mornings during the NFL season.
- New system version releases shall be deployed at the beginning of each NFL season.
...
- The system shall achieve 95 % uptime.
- The website shall be available for use 24 hours per day, 365 days per year.

Look and Feel:
- The application shall match the color schema set forth by the Department of Homeland Security.
- The look and feel of the system shall conform to the user-interface standards of the smart device.
- The user interface shall have standard menus and buttons for navigation.
...
Fault Tolerance:
- The product shall operate in offline mode whenever an internet connection is unavailable.
...
- 100 % of saved user preferences shall be restored when the system comes back online.
"""
